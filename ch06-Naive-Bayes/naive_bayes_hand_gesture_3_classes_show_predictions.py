...
class_00_dir = os.path.join(data_dir, "class_0")
class_01_dir = os.path.join(data_dir, "class_1")
class_02_dir = os.path.join(data_dir, "class_2")
...
for label, img_dir in enumerate([class_00_dir, class_01_dir, class_02_dir]):
...
def display_predictions(images, labels, predictions, num_images=24):
    ...
    plt.tight_layout()
    out_path = os.path.join(base_dir, "sample_predictions_3_classes.png")
